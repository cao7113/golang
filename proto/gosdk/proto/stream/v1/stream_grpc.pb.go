...
func (c *streamServiceClient) Hi(ctx context.Context, in *HiRequest, opts ...grpc.CallOption) (StreamService_HiClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/proto.stream.v1.StreamService/Hi", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) ClientStream(ctx context.Context, opts ...grpc.CallOption) (StreamService_ClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[1], "/proto.stream.v1.StreamService/ClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) BiStream(ctx context.Context, opts ...grpc.CallOption) (StreamService_BiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[2], "/proto.stream.v1.StreamService/BiStream", opts...)
	if err != nil {
		return nil, err
	}
